...
$kendo_url = 'bower_components/kendo-ui-core/js';
...
if(substr($sPage, 0, 5 ) === "forms") {
    ...
    $scripts = '
    <!-- ionrangeslider -->
    <script src="'.$bower_url.'/ionrangeslider/js/ion.rangeSlider'.$dist_min.'.js"></script>
    <!-- htmleditor (codeMirror) -->
...
if(substr($sPage, 0, 7 ) === "kendoui") {
    ...
    $scripts = '
    <!-- kendo UI -->
    <script src="assets/js/kendoui.custom'.$dist_min.'.js"></script>
